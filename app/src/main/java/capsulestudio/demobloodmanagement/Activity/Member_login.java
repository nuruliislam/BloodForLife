...
public class Member_login extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        sharedpreferences = getSharedPreferences(memberPREFERENCES, Context.MODE_PRIVATE);
        ...
        _signupLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), Member_signup.class);
    ...
    {
        pDialog = new ProgressDialog(Member_login.this,
        ...
        userCall.enqueue(new Callback<MSG>() {
            ...
            public void onResponse(Call<MSG> call, Response<MSG> response) {
                ...
                if(response.body().getSuccess() == 1)
                {
                    ...
                    editor.putString(member_email_key, e);
                    editor.putString(member_password_key, p);

                    editor.commit();


                    Intent i=new Intent(Member_login.this,Member_Activity.class);
                    i.putExtra("email",e);
                ...
                }else
                {
                    ...
                    Toast.makeText(Member_login.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
