...
public class Add_Hospital extends AppCompatActivity {
    ...
    private void saveToServerDB() {
        ...
        pDialog = new ProgressDialog(Add_Hospital.this,
        ...
        Call<MSG> userCall = service.addHospital(name, email, phone, password, address, city);
        ...
        userCall.enqueue(new Callback<MSG>() {
            ...
            public void onResponse(Call<MSG> call, Response<MSG> response)
            {
                ...
                {
                    startActivity(new Intent(Add_Hospital.this, Admin_Activity.class));

                    finish();
                } else
                    {
                    Toast.makeText(Add_Hospital.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    hidepDialog();
                }
            }
