...
public class Admin_Login extends AppCompatActivity
{
    ...
    {
        pDialog = new ProgressDialog(Admin_Login.this,
        ...
        Call<MSG> userCall = service.adminLogIn(email,password);
        ...
        userCall.enqueue(new Callback<MSG>() {
            ...
            public void onResponse(Call<MSG> call, Response<MSG> response) {
                ...
                if(response.body().getSuccess() == 1)
                {
                    ...
                    editor.putString(admin_email_key, e);
                    editor.putString(admin_password_key, p);
                ...
                }else
                {
                    ...
                    Toast.makeText(Admin_Login.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
